            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col h-[85vh] gap-3 main_form_add">
                ...
                {school !== "" && (
                    <>
                        ...
                        />
                        <label className="text-[20px] poppins-2 text-white font-bold -mb-3" htmlFor="">Sektorni tanlang</label>
                ...
                <div className='anons flex gap-1 md:mt-10  justify-center'>
                    <h1 className='text-center text-[16px] poppins-2 text-white'>Web Sayt Chortoq IT Park jamoasi tomonidan tuzildi
