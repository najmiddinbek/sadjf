...
const PupilsAddClient = () => {
	...
	const [MFY, setMFY] = useState('2-sektor')
		...
		<>
			...
			>
				<div className='text-end'>
					<Link
						className='green rounded-md py-3 px-10 text-white button'
						href={'/'}
					>
						Orqaga
					</Link>
				...
				<label
					className='text-[13px] poppins-2 text-white font-bold -mb-3'
					htmlFor=''
				>
					Maktabni tanlang
				</label>
				...
				{school !== '' && (
					<>
						<label
							className='text-[20px] font-bold poppins-2 text-white -mb-3'
							htmlFor=''
						>
							Sinfni tanlang
						</label>
						...
						/>
						<label
							className='text-[20px] poppins-2 text-white font-bold -mb-3'
							htmlFor=''
						>
							Sektorni tanlang
						</label>
				...
				{school === '' && (
					<>
						<label
							className='text-[18px] font-bold poppins-2 text-white'
							htmlFor=''
						>
							Sinfni tanlang
						</label>
						...
						/>
						<label
							className='text-[13px] poppins-2 text-white font-bold'
							htmlFor=''
						>
							Sektor tanlang
						</label>
						<select
							className='px-2 text-[13px] py-3 cursor-no-drop border'
							onChange={e => setMFY(e.target.value)}
							value={MFY}
						>
						...
						<label
							className='text-[13px] font-bold poppins-2 text-white'
							htmlFor=''
						>
							Qoldirilgan dars vaqti
						</label>
						<select
							onChange={e => setNewDarsQoldirish(e.target.value)}
							value={newDarsQoldirish}
							className='border  text-opacity-25 text-[13px] outline-none rounded-md px-2 py-3 cursor-no-drop'
						>
